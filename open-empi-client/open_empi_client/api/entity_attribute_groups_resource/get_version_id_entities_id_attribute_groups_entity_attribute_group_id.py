...
def sync_detailed(
    ...
    *,
    ...
    """Retrieve an entity attribute group

     This endpoint allows you to load the details of an attribute group in an entity that is located by
    entity identifier and entity attribute group identifier

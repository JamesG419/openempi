...
def sync_detailed(
    ...
    *,
    ...
    """Delete an entity attribute group

     This endpoint allows you to delete an attribute group in an entity that is located by entity
    identifier and entity attribute group identifier.

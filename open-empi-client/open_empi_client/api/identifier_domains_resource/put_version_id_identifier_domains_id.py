...
def sync_detailed(
    ...
    *,
    ...
    """Update an identifier domain

     Use this endpoint to update the value of an identifier domain. An identifier domain is an object
    that defines an organization that assigns identifiers to records. The identifier domain id you
    provide in the path must point to an existing identifier domain.

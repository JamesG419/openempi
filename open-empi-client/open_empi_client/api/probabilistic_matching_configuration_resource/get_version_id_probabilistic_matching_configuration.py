...
def sync_detailed(
    ...
    *,
    ...
    """Get the probabilistic matching service configuration

     This endpoint allows you to retrieve the current configuration of the probabilistic matching service
